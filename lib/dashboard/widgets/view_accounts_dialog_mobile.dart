...
class ViewAccountsDialogMobile extends StatefulWidget {
  const ViewAccountsDialogMobile({super.key, required this.hidePopup, required this.width});
  final Function() hidePopup;
  final double width;

  @override
  State<ViewAccountsDialogMobile> createState() => _ViewAccountsDialogMobileState();
}

class _ViewAccountsDialogMobileState extends State<ViewAccountsDialogMobile> {
    ...
    return Material(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            buildSuggestionsExpansionTile(authProvider.savedUser!.email,account1, account2, account3, account4),
            SizedBox(height: 10),
              ...
              builder: (context, fileProvider, _) {
                return Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text('Account Storage', style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold)),
  ...
  ExpansionTile buildSuggestionsExpansionTile(String email, String account1, String account2, String account3, String account4) {
      ...
      title: Row(
        children: [
          Container(
            ...
            child: Text(email[0].toUpperCase(), style: const TextStyle(color: Colors.white, fontSize: 15, fontWeight: FontWeight.bold) ),
          ),
          SizedBox(width: 6),
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
